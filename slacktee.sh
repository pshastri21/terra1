...
# ----------
webhook_url="https://hooks.slack.com/services/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"       # Incoming Webhooks integration URL. Old way to interact with Slack. (Deprecated)
token="xoxb-3157859730822-3226979768982-k7Jbpu1wk9YpqiATnszLjUn6"            # The authentication token of the bot user. Used for accessing Slack APIs.
...
attachment="yellow"        # Default color of the attachments. If an empty string is specified, the attachments are not used.
