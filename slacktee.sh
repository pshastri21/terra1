...
# ----------
webhook_url="https://hooks.slack.com/services/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"       # Incoming Webhooks integration URL. Old way to interact with Slack. (Deprecated)
token="xoxb-3157859730822-3226979768982-xmo0SY7jqEpL8pS22lnUIMOy"            # The authentication token of the bot user. Used for accessing Slack APIs.
